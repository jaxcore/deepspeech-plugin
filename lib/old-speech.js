...
class OldSpeech extends Service {	// todo: this class no longer has to extend jaxcore Service
	...
	static getOrCreateInstance(serviceStore, serviceId, serviceConfig, callback) {
		if (!speechInstance) {
			...
			speechInstance = new OldSpeech(serviceConfig, serviceStore);
		}
