...
Speech.prototype = new EventListener();
Speech.prototype.constructor = EventListener;
...
Speech.prototype.startContinuous = function (options) {
...
Speech.prototype.stopContinuous = function () {
	this.continuousStopped = true;
};
Speech.prototype._stopContinuousStream = function () {
...
Speech.prototype._recordContinuous = function (data) {
...
Speech.prototype._processSilence = function (data) {
	// clearTimeout(this.segmentTimer);
	if (this.isRecognizing) {
		console.log('.r');
		this.continuousStream.write(data);
...
Speech.prototype._finishContinuous = function () {
...
Speech.prototype.startRecognizing = function () {
...
Speech.prototype.recognize = function (memoryStream) {
